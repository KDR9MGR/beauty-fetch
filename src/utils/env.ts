...
export const validateEnvironment = () => {
  try {
    ...
    return {
      supabaseUrl: "https://ysmzgrtfxbtqkaeltoug.supabase.co",
      supabaseAnonKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlzbXpncnRmeGJ0cWthZWx0b3VnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDczOTQzMzcsImV4cCI6MjA2Mjk3MDMzN30.C6WxgdAj3g7fk1IsQRufUhckn-n_eOta_8vR_PVY0d8",
...
let envInstance: ReturnType<typeof validateEnvironment> | null = null;

export const env = new Proxy({} as ReturnType<typeof validateEnvironment>, {
  get(target, prop) {
    if (!envInstance) {
      envInstance = validateEnvironment();
    }
